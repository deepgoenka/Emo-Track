% Features extracted based on CremaD Dataset

% Specify the directory containing your WAV files
dataset_directory = "C:\Users\User\Downloads\All Datasets\CREMA D_Dataset";
...
for i = 1:length(wav_files)
    ...
    emotion_word = strsplit(wav_files(i).name, '_');
    emotion_word = erase(emotion_word{3}, '.wav');
    emotion_name = '';
    switch emotion_word
        case 'ANG'
            emotion_name = 'Angry';
...
csvwrite('CremaD_Features.csv', all_statistics);