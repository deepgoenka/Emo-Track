% Features extracted based on EmoDB Dataset

% Specify the directory containing your WAV files
dataset_directory = "C:\Users\User\Downloads\All Datasets\EmoDB_Dataset";
...
for i = 1:length(wav_files)
    ...
    emotion_label = file_name(6); % Assuming the label is the sixth character of the file name
...
csvwrite('EmoDB_Features.csv', all_statistics);